<div class="p-6">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full border border-slate-200 text-sm whitespace-nowrap">
            ...
            <div class="mt-6 border rounded-lg bg-slate-50 p-5">
                ...
                @if($agregandoContribuyente)
                    <div class="border rounded p-3 mb-3 bg-white"
                        ...
                        <div style="width:420px;">
                            ...
                            <select
                                wire:model="nuevo_contribuyente_asesoria_id"
                                class="border rounded px-2 py-1"
                                style="width:100%;">
                                <option value="">Seleccione...</option>

                                @foreach($contribuyentesDisponibles as $contribuyente)
                            ...
                            @error('nuevo_contribuyente_asesoria_id')
                        ...
                        <div style="display:flex; gap:8px;">
                            <button
                                type="button"
                                wire:click="guardarNuevoContribuyente"
                ...
                @forelse($asesoriaSeleccionada->contribuyentes as $item)
                    <div class="border rounded p-2 mb-2 bg-white text-sm">
                        ...
                        <button
                            type="button"
                            onclick="confirm('¿Está seguro de eliminar este contribuyente de la asesoría?') || event.stopImmediatePropagation()"
                            wire:click="eliminarContribuyente({{ $item->id }})"
                            style="background:#dc2626; color:white; padding:4px 10px; border-radius:6px; margin-left:8px;">
                            Eliminar
                        </button>
                ...
                @forelse($asesoriaSeleccionada->tramites as $detalle)
                    <div wire:key="tramite-detalle-{{ $detalle->id }}" class="border rounded p-3 mb-2 bg-white">
                        ...
                        <div class="text-sm mt-1">
                            ...
                            Contribuyente:
                            <span style="background:#e0f2fe; color:#075985; padding:2px 8px; border-radius:999px; font-weight:600;">
                                Contribuyente: {{ $detalle->contribuyente?->razon_social ?? '—' }}
                            </span>
