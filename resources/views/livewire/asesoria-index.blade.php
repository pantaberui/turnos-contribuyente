<div class="p-4">
    ...
    <div class="max-w-7xl mx-auto">
            ...
            <div class="mb-4 rounded-lg border border-blue-300 bg-blue-50 p-5">
                ...
                <div class="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    <div>
                        ...
                        @if($asesoriaTelefonicaActual->contribuyente)
                            {{ $asesoriaTelefonicaActual->contribuyente->razon_social }}
                        @else
                            <span class="text-slate-500">
                                SIN CONTRIBUYENTE ASIGNADO
                            </span>
                        @endif
                    </div>
                    ...
                    <div
                        x-data="{
                            inicio: new Date('{{ $asesoriaTelefonicaActual->inicio_atencion->format('Y-m-d\TH:i:s') }}'),
                            tiempo: '00:00:00',
        ...
        {{-- ========================================================= --}}
        {{-- NUEVA ASESORÍA TELEFÓNICA / CAPTURA --}}
        {{-- ========================================================= --}}

        @if ($mostrandoLlamada && !$llamadaEnCurso)
            ...
            <div class="mb-6 bg-white rounded-xl shadow-md border border-slate-200 p-6">
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">
                            El tiempo de atención inició al comenzar la llamada.
                        </p>
                    </div>
                ...
                <div class="mt-6 mb-6">
                    ...
                    <div
                        style="display:grid; grid-template-columns:220px 260px 1fr 130px; gap:16px; align-items:end;"
                    >
        ...
        {{-- ========================================================= --}}
        {{-- BOTONES NUEVA LLAMADA / NUEVO CORREO --}}
        {{-- ========================================================= --}}
            ...
            <div class="rounded-lg bg-green-50 border border-green-200 p-6">
                ...
                @if($this->turnoActual->estatus_turno_id == 2)
                    ...
                    <div
                        ...
                        x-data="{
                            inicio: new Date(
                                '{{ $this->turnoActual->fecha->format('Y-m-d') }}T{{ $this->turnoActual->hora_inicio_atencion }}'
                            ),
                            tiempo: '00:00:00',
                    ...
                    >
                        ...
                        <p class="text-3xl font-bold" x-text="tiempo"></p>
                ...
                {{-- LLAMAR NUEVAMENTE --}}
                @if(
                    $this->turnoActual->estatus_turno_id == 7 &&
                    $this->turnoActual->numero_llamados < 3
                )
        ...
        @else
            ...
            @if($correoEnCurso && $asesoriaCorreoActual)
                ...
                <div class="mb-4 rounded-lg border border-purple-300 bg-purple-50 p-5">
                    ...
                    <div class="mt-3 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div
                            x-data="{
                                inicio: new Date('{{ $asesoriaCorreoActual->inicio_atencion->format('Y-m-d\TH:i:s') }}'),
                                tiempo: '00:00:00',
            ...
            {{-- ===================================================== --}}
            {{-- SIN TURNO / SIN LLAMADA / SIN CORREO --}}
            {{-- ===================================================== --}}
        ...
        {{-- ========================================================= --}}
        {{-- AGREGAR CONTRIBUYENTE ADICIONAL --}}
        {{-- ========================================================= --}}
                                            ...
                                            @forelse($clasificacion->tramites as $tramite)
                                                ...
                                                <div class="border rounded-md p-3">
                                                    ...
                                                    <div class="flex items-center gap-3 flex-wrap">
                                                        ...
                                                        <input
                                                            type="checkbox"
                                                            wire:click="toggleTramite(
                                                                {{ $turnoContribuyente->contribuyente_id }},
                                                                {{ $tramite->id }}
                                                            )"
                                                            @checked(
                                                                isset(
